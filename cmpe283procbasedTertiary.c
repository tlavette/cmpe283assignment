 ...
 * See Intel Trust Domain CPU Architecture Section 1.4.1
 */
 ...
 * See SDM volume 3D, section 25.6.2
 */
struct capability_info tertiary[6] =
{
	{ 0, "LOADIWKEY exiting" },
	{ 1, "Enable HLAT" },
...
detect_vmx_features(void)
{
	...
	/* Procbased 3 controls */
	rdmsr(IA32_VMX_PROCBASED_CTLS3, lo, hi);
	pr_info("Procbase tertiary Controls MSR: 0x%llx\n",
		(uint64_t)(lo | (uint64_t)hi << 32));
	report_capability(tertiary, 6, lo, hi);
}
